...
public class Membership_Renewal_Test {
	...
	public void Step02_Find_Two_Member_And_Get_Detail() {
		...
		test.memberShipPage.selectAndRunQueryMembership(getMemRenewalInfo
				.getMemRenewalInfo("queryName"));
		test.memberShipPage.enterCustomerIdsInRunQuery(memberDetail1.get(3),
				memberDetail2.get(3));
		test.memberShipPage.verifyMultipleRecordsInList("2");
		obj[0] = memberDetail1;
		obj[1] = memberDetail2;
	}
	...
	public void Step04_verify_Renewal_For_Scheduled_Processing_Success() {
		...
		test.membershipRenewalPage.verifyRenewalSubDetails(getMemRenewalInfo
				.getRenewalInfoForScheduled("numberOfRenewals"),
				getMemRenewalInfo
						.getRenewalInfoForScheduled("numberofInvoicesCreated"),
				getMemRenewalInfo.getRenewalInfoForScheduled("numberOfErrors"));
		...
		test.membershipRenewalPage
				.verifyRenewalSubDetails(
						getMemRenewalInfo
								.getRenewalInfoForProcessing("numberOfRenewals"),
						getMemRenewalInfo
								.getRenewalInfoForProcessing("numberofInvoicesCreated"),
						getMemRenewalInfo
								.getRenewalInfoForProcessing("numberOfErrors"));
	}
	...
	public void Step06_Verify_Renewal_Details_For_create_Renewal_Invoices() {
		...
		test.membershipRenewalPage
				.verifyRenewalSubDetails(
						getMemRenewalInfo
								.getCreateRenewalInvoiceInfo("numberOfRenewals"),
						getMemRenewalInfo
								.getCreateRenewalInvoiceInfo("numberofInvoicesCreated"),
						getMemRenewalInfo
								.getCreateRenewalInvoiceInfo("numberOfErrors"));
	}
	...
	public void Step07_Navigate_To_Membership_Profile_Page_And_Verify_Details_Test() {
		...
		test.memberShipPage.verifyInvoiceDetailsOnRenewal(memberDetails.get(7),
				memberDetails.get(8), memberDetails.get(9));
		invocationCount++;
	}
