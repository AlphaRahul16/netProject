...
//	private String caseID;
	...
	@Test(groups = { "3", "4" },dependsOnMethods="Step01_Launch_Iweb_Application")
	public void Step02_Navigate_To_CRM_Module_And_Execute_Query() {
		...
		test.memberShipPage.enterSingleCustomerIdInRunQuery(DateUtil.getCurrentdateInStringWithGivenFormateForTimeZone("MM/dd/yy","EST5EDT"));
//		test.memberShipPage.clickOnGoButtonAfterPackageSelection();
		test.memberShipPage.getCustomerID(); // ------ alert handling
	}

	@Test(groups = { "3", "4" },dependsOnMethods="Step02_Navigate_To_CRM_Module_And_Execute_Query")
	...
	@Test(groups = { "3", "4" },dependsOnMethods="Step03_Verify_Term_Dates_For_National_And_Chapter_Membership")
	...
	@Test(groups = { "3", "4" },dependsOnMethods="Step04_Verfiy_Invoice_With_Null_Term_Dates_And_Click_On_Customer_Name")
	...
	@Test(groups = { "3", "4" },dependsOnMethods="Step05_Add_new_Local_Section")
	...
	@Test(groups = {"4"},dependsOnMethods="Step06_Verify_Individual_Membership_Details_Are_Unchnaged")
	...
	@Test(groups = { "3"},dependsOnMethods="Step06_Verify_Individual_Membership_Details_Are_Unchnaged")
	...
	@Test(groups = { "3", "4" },dependsOnMethods="Step06_Verify_Individual_Membership_Details_Are_Unchnaged")
	...
	@Test(groups = { "4" },dependsOnMethods="Step08_Add_Payment_On_Accounting_Profile_Page_For_scenario3")
	public void Step09_Verify_Term_Dates_For_Scenario4() {// scenario4
		...
		test.memberShipPage.verifyTerminateDateIsCurrentDate(newChpName,individualDates.get("ExpireDate").toString(), 
				6, "Expire date");
	...
	@Test(groups = { "3"},dependsOnMethods="Step08_Add_Payment_On_Accounting_Profile_Page_For_scenario3")
