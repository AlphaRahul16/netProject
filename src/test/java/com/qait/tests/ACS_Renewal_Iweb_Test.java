...
public class ACS_Renewal_Iweb_Test extends BaseTest {
	...
	public void Step03_Add_Payment_And_Verify_Details_After_Apply_Payment_Test() {
		...
		test.memberShipPage.fillAllTypeOFPaymentDetails(mapRenewalIweb.get("Payment_Method"), mapRenewalIweb.get("Visa_Card_Number"), mapRenewalIweb.get("Diners_Card_Number"), mapRenewalIweb.get("Reference_Number"),
				mapRenewalIweb.get("Discover_Card_Number"),test.homePageIWEB.map().get("AMEX_Card_Number"), mapRenewalIweb.get("Expiry_Date"), mapRenewalIweb.get("CVV_Number"), mapRenewalIweb.get("Check_Number"));
