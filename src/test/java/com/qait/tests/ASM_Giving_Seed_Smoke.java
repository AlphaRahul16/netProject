...
public class ASM_Giving_Seed_Smoke {

	TestSessionInitiator test;
	static String app_url_GivinSeed;
	...
	@Test
	public void Step02_TC02_Enter_Valid_Username_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				DataProvider.getColumnData(tcId, headerName),
	...
	@Test
	public void Step03_TC03_Enter_Valid_Member_Number_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
	...
	@Test
	public void Step04_TC04_Enter_Valid_lastname_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWith_Lastname_Member_Number(
				DataProvider.getColumnData(tcId, headerName),
	...
	@Test
	public void Step06_TC06_Enter_Valid_Email_At_Contact_Info_Page_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step07_TC07_Enter_Valid_Address_At_Contact_Info_Page_And_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step08_TC08_Enter_Valid_City_At_Contact_Info_Page_And_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step09_TC09_Select_Valid_State_At_Contact_Info_Page_And_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step10_TC10_Enter_Valid_zipcode_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step11_TC11_Enter_Invalid_Credit_Card_Number_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step12_TC12_Enter_Valid_Credit_Card_Number_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step13_TC13_Enter_Valid_Credit_Card_Holder_Name_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
		...
		test.asm_givingGreen.verifyCurrentPage("Confirm your donation");
		test.asm_Donate.enterPaymentDetails(YamlReader
				.getYamlValue("creditCardInfo.Type"), DataProvider
				.getColumnData(tcId, headerName), YamlReader
	...
	@Test
	public void Step14_TC14_Enter_Valid_CVV_Number_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step15_TC15_Enter_Valid_First_Name_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
	...
	@Test
	public void Step16_TC16_Enter_Valid_Last_Name_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_Donate.clickOnContinueAsGuest();
		test.asm_Donate.enterRequiredDetailsInNonMemberForm(
	...
	@Test
	public void Step17_TC17_Enter_Valid_Email_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_Donate.clickOnContinueAsGuest();
		test.asm_Donate.enterRequiredDetailsInNonMemberForm(
	...
	@Test
	public void Step18_TC18_Enter_Valid_Address_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_Donate.clickOnContinueAsGuest();
		test.asm_Donate.enterRequiredDetailsInNonMemberForm(
	...
	@Test
	public void Step19_TC19_Enter_Valid_City_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_Donate.clickOnContinueAsGuest();
		test.asm_Donate.enterRequiredDetailsInNonMemberForm(
	...
	@Test
	public void Step20_TC20_Enter_Valid_State_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_Donate.clickOnContinueAsGuest();
		test.asm_Donate.enterRequiredDetailsInNonMemberForm(
	...
	@Test
	public void Step21_TC21_Enter_Valid_Zipcode_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_Donate.clickOnContinueAsGuest();
		test.asm_Donate.enterRequiredDetailsInNonMemberForm(
	...
	@Test
	public void Step22_TC22_Enter_Invalid_Recipient_Email_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step23_TC23_Enter_Valid_Recipient_Email_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step24_TC24_Enter_Valid_Email_In_Postal_Address_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step25_TC25_Enter_Valid_Addres_In_Postal_Address_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step26_TC26_Enter_Valid_City_In_Postal_Address_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step27_TC27_Enter_Valid_ZipCode_In_Postal_Address_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step28_TC28_Enter_Valid_Credit_Card_Number_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step29_TC29_Enter_InValid_Credit_Card_Number_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	@Test
	public void Step30_TC30_Enter_Valid_CVV_And_Verify_ASM_Error_Not_Present() {
		String tcId = test.asm_Donate.getTestCaseID(Thread.currentThread()
				.getStackTrace()[1].getMethodName());
		test.asm_givingGreen.loginIntoApplicationWithACS_ID(
				getASM_givingGreen.getASM_GivingGreen("userName"),
	...
	public void launchApplication() {
		...
		app_url_GivinSeed = getYamlValue("app_url_givingSeed");
		...
		test.launchApplication(app_url_GivinSeed);
	}
