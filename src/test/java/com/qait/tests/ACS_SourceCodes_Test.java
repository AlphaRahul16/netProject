...
//	    name=test.memberShipPage.getDomesticSourceCode();
//	    test.memberShipPage.clickOnArrowButton(name);
...
//		test.checkoutPage.verifyPublication(caseID);
	...
	@Test
	public void Step07_Launch_Iweb_Application_And_Find_Individual(){
	...
	@Test
	public void Step08_Verify_Member_Details_And_Source_Code(){
	...
	@Test
	public void Step09_Verify_Invoice_Details(){
	...
	@Test
	public void Step10_Verify_Payment_Details(){
