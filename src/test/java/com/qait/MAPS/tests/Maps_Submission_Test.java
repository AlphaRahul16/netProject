...
public class Maps_Submission_Test extends BaseTest {
	...
	@Test
	public void Test07_MAPS_94_Submit_Details_On_Title_Body_Page() {// verification
																	// to be
																	// added in
																	// the end
	...
	public void Test08_MAPS_106_Submit_Details_Select_Symposium_Page() {
		test.maps_submissionPage.submitDetailsOnSelectSymposiumPage("1. Oral Only", "Coffee & Cocoa Products",
				"1. Consider for Sci-Mix");
		test.maps_submissionPage.clickOnSaveAndContinueButton();
	...
	@Test
	public void Test09_MAPS_118_Verify_Application_Creates_New_institution_And_Navigates_Back_To_Author_Page() {// verification
																												// to
																												// be
																												// added
																												// in
