	...
	private static WebDriver getFirefoxDriver(String path,String tier) {
		...
		if (tier.equalsIgnoreCase("Dev7")) {
			String firefoxProfilePath = "." + File.separator + "src" + File.separator + "test" + File.separator
					+ "resources" + File.separator + "Profile_" + tier;
			String autoAuthPath = "." + File.separator + "src" + File.separator + "test" + File.separator + "resources"
					+ File.separator + "AddOn" + File.separator + "autoauth-2.1-fx+fn_0.xpi";
