...
list_nominees                             xpath               //img[contains(@src,'img_')]/../preceding-sibling::td[5]/a
...
link_goToJudgeRecord                      xpath                (//td[starts-with(text(),'${judgeName}')]/preceding-sibling::td[1]/a[@title='goto record'])[last()]
