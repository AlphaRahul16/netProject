...
txt_effectiveDateForActive                           xpath                    //td[contains(text(),'Active')]/following-sibling::td[3]
txt_expireDateForActive                              xpath                    //td[contains(text(),'Active')]/following-sibling::td[4]
