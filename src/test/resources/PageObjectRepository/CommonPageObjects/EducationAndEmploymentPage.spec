...
btn_addAnotherDegreePosition       xpath     //td[@style='padding-bottom: 0em;']
header_sectionName                 id        lbl${headerName}SectionHeader
txt_chemistryTeacher               css       #lblPreCollegeTeacherDescription>p
condition_empDetail                xpath     //label[@for='employment-${empDetail}']
txt_headerCondition                xpath     //span[text()='${header}']/../following-sibling::span
====================================================================================