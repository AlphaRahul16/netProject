...
btn_verify               	   xpath               //div[@class='action']//input[contains(@id,btnLogin)]
...
drpdown_state                  xpath                (//select[contains(@id,'ddlState')])[1]/option[contains(text(),'${value}')]
...
drpdown_stateBilling           xpath                (//select[contains(@id,'ddlState')])[2]/option[contains(text(),'${value}')]
